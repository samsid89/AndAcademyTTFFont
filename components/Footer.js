            ...
            <Col md={3}>
              <div className="div">
                ...
                <p className="p">
                    ...
                    <a href="/graphic-design-course" className="a">Graphic Design Diploma</a>
                 
                </p>
                <p className="p">
                 
                    <a href="/interior-design-course" className="a">Interior Design Diploma</a>
                  
                </p>
                <p className="p">
                 
                    <a href="/communication-design-pg-diploma" className="a">Communication Design PG Diploma</a>
            ...
            <Col md={3}>
              <div className="div">
                ...
                <p className="p">
                    ...
                    <a href="/user-experience-design-course" className="a">User Experience Diploma</a>
                  
                </p>
                <p className="p">
                  
                    <a href="/motion-graphics-animation-course" className="a">Motion Graphics Diploma</a>
                  
                </p>
                <p className="p">
                  
                    <a href="/digital-brand-communication-course" className="a">Digital Brand Communication Diploma</a>
