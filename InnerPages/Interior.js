  ...
  return (
    <>
      <Helmet>
        ...
        />
        <title>Interior Design Course | Diploma in Interior Designing | AND Academy</title>
      </Helmet>
          ...
          <div className="row">
            ...
            <div className="col-md-4">
              <div
                ...
                style={{
                  background:
                    "url(/images/Interior/digital_below_box.jpg) no-repeat",
                  backgroundSize: "cover",
                  height: "100%",
                }}
              ></div>
          ...
          <div className="row">
            ...
            <div className="col-md-4">
              <div
                ...
                style={{
                  background:
                    "url(/images/Interior/motion_below_box.jpg) no-repeat",
                  backgroundSize: "cover",
                  height: "100%",
                }}
              ></div>
          ...
          <div className="row">
            <div className="col-md-4">
              <div
                ...
                style={{
                  background:
                    "url(/images/Interior/graphic_below_box.jpg) no-repeat",
                  backgroundSize: "cover",
                  height: "100%",
                }}
              ></div>
