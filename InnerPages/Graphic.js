        ...
        <div className="container-fluid">
          <div className="row">
            ...
            <div className="col-md-6">
              ...
              <a
                href="https://www.andacademy.com/communication-design-pg-diploma/"
                className="a"
              >
                <img
          ...
          <div className="row">
            ...
            <div className="col-md-4">
              <div
                ...
                style={{
                  background:
                    "url(../images/Graphic/motion_below_box.jpg) no-repeat",
                  backgroundSize: "cover",
                  height: "100%",
                }}
              ></div>
          ...
          <div className="row">
            ...
            <div className="col-md-4">
              <div
                ...
                style={{
                  background:
                    "url(../images/Graphic/digital_below_box.jpg) no-repeat",
                  backgroundSize: "cover",
                  height: "100%",
                }}
              ></div>
