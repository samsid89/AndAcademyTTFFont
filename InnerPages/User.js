  ...
  return (
    <>
      <Helmet>
        ...
        />
        <title>UX/UI Course | User Experience Design Diploma | AND Academy</title>
      </Helmet>
              ...
              <div className="row">
                <div className="col-md-5">
                  <div className="text-div">
                    <h3 className="h3">Application Deadline: 24.04.2022</h3>
                  </div>
                </div>
        ...
        <div className="container-fluid">
          <div className="row">
            ...
            <div className="col-md-6">
              ...
              <a href="https://www.andacademy.com/communication-design-pg-diploma/">
                <img
          ...
          <div className="row">
            ...
            <div className="col-md-4">
              <div
                ...
                style={{
                  background:
                    "url(../images/User/motion_below_box.jpg) no-repeat",
                  backgroundSize: "cover",
                  height: "100%",
                }}
              ></div>
          ...
          <div className="row">
            <div className="col-md-4">
              <div
                ...
                style={{
                  background:
                    "url(../images/User/graphic_below_box.jpg) no-repeat",
                  backgroundSize: "cover",
                  height: "100%",
                }}
              ></div>
          ...
          <div className="row">
            ...
            <div className="col-md-4">
              <div
                ...
                style={{
                  background:
                    "url(../images/User/digital_below_box.jpg) no-repeat",
                  backgroundSize: "cover",
                  height: "100%",
                }}
              ></div>
