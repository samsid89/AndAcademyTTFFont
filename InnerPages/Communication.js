  ...
  return (
    <>
      <Helmet>
        ...
        />
        <title>
          PG Diploma in Communication Design | Visual Communication Course | AND Academy
        </title>
      </Helmet>
              ...
              <div className="text-div text-div-cent">
                ...
                <div className="mob-h2">
                  <div className="specialis_div_mob">
                    ...
                    Graphic Design
                    <h3 className="h3">Application Deadline: 08.04.2022</h3>
                  </div>
          ...
          <div className="row">
            <div className="col-md-4">
              <div
                ...
                style={{
                  background:
                    "url(../images/Communication/digital_below_box.jpg) no-repeat",
                  backgroundSize: "cover",
          ...
          <div className="row">
            ...
            <div className="col-md-4">
              <div
                ...
                style={{
                  background:
                    "url(../images/Communication/graphic_below_box.jpg) no-repeat",
                  backgroundSize: "cover",
                  height: "100%",
                }}
              ></div>
          ...
          <div className="row">
            <div className="col-md-4">
              <div
                ...
                style={{
                  background:
                    "url(../images/Communication/motion_below_box.jpg) no-repeat",
                  backgroundSize: "cover",
                  height: "100%",
                }}
              ></div>
